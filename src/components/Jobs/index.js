...
class Jobs extends Component {
  ...
  getJobs = async () => {
    ...
    if (response.ok) {
      ...
      this.setState({
        ...
        displayResultsText:
          activeEmploymentTypeIds.length > 0 ||
          activeSalaryRangeId !== '' ||
          searchInput !== '',
      })
    } else {
  ...
  render() {
    const {searchInput, jobsList, displayResultsText} = this.state
        ...
        <div className="jobs">
          <div className="jobs-responsive-container">
            ...
            <div className="jobs-list-container">
              ...
              {displayResultsText && (
                <p className="results-text">Found {jobsList.length} results</p>
              )}
              {this.renderJobs()}
            </div>
          </div>
